...
extension WaterViewController: ARSessionDelegate {
...
extension WaterViewController: ARSCNViewDelegate {
    
    public func renderer(_: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        guard planeNode == nil else { return nil }
        
        if anchor is ARPlaneAnchor {
            planeNode = PlaneNode(sceneView: sceneView, viewportSize: viewFrame!.size, mode: .Water)
